...
//        result = testAndDeepen(result, 193_690_690);
    ...
    public void position3() {
        final Board bitboard = new Bitboard(Fen.parse("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -"));
    ...
    public void position4() {
        final Board bitboard = new Bitboard(Fen.parse("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1"));
    ...
    public void position4Mirrored() {
        final Board bitboard = new Bitboard(Fen.parse("r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1"));
    ...
    public void position5() {
        final Board bitboard = new Bitboard(Fen.parse("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8"));
...
//        result = testAndDeepen(result, 89_941_194);
    ...
    public void position6() {
        final Board bitboard = new Bitboard(Fen.parse("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10"));
...
//        }
    ...
    private void stockfishDiff(final DeepenResult previous) {
        previous.validMoves.parallelStream().forEach(validMove -> {
            ...
            final String fen = ((Bitboard) validMove.getBoard()).fen();
